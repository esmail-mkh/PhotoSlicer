...
**فوتو اسلایسر (PhotoSlicer)** یک نرم‌افزار فوق‌سریع، زیبا و پر از امکانات است که مخصوص **مترجمین و ادیتورهای وبتون، مانگا و منهوا** طراحی شده است. این برنامه فرآیند خسته‌کننده چسباندن تصاویر، تغییر سایز، افزایش کیفیت با هوش مصنوعی و برش مجدد آن‌ها را به صورت کاملاً خودکار انجام می‌دهد.
...
*   **عملکرد:** استفاده از معماری Multi-thread برای سرعت بالا در برش و تغییر سایز.
...
3.  **راه‌اندازی هوش مصنوعی (اختیاری):**
    برای استفاده از قابلیت "AI Enhance":
    *   فایل اجرایی `realesrgan-ncnn-vulkan.exe` را دانلود کنید.
    *   یک پوشه به نام `up-model` در کنار فایل `main.py` بسازید.
    *   فایل exe و مدل‌های همراهش را درون آن کپی کنید.
...
خوشحال می‌شویم در توسعه این پروژه مشارکت کنید! پول ریکوئست‌های شما پذیرفته می‌شود.
